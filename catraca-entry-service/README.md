...
O banco SQLite e os tokens renovados ficam no volume `./data`. Se o access token expirar, o serviço tenta renová-lo e persiste a rotação do refresh token nesse volume.
